package com.kk.taurus.ijkplayer.view;
...
public class SmileView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mBorderPaint.setShader(new LinearGradient(0, 0, mWidth, mHeight, Color.YELLOW, Color.GREEN, Shader.TileMode.MIRROR));
        mFacePaint.setShader(new LinearGradient(0, 0, mWidth, mHeight, Color.YELLOW, Color.GREEN, Shader.TileMode.MIRROR));
