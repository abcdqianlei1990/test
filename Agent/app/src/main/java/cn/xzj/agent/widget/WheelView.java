...
//            this.setLayoutParams(new ConstraintLayout.LayoutParams(lp.width, itemHeight * displayItemCount));
            this.setLayoutParams(new ConstraintLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, itemHeight * displayItemCount));
        }
        return tv;
    }
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#29AC3E"));
