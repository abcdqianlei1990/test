...
import cn.xzj.agent.util.zxing.BarcodeFormat;
import cn.xzj.agent.util.zxing.BitMatrix;
import cn.xzj.agent.util.zxing.CharacterSetECI;
import cn.xzj.agent.util.zxing.EncodeHintType;
import cn.xzj.agent.util.zxing.ErrorCorrectionLevel;
import cn.xzj.agent.util.zxing.QRCodeWriter;
import cn.xzj.agent.util.zxing.WriterException;
