...
public class RootFrameLayout extends FrameLayout {
    ...
    public void addAllLayoutToLayout() {
        ...
        if (mStatusLayoutManager.contentLayout!=null)
            layoutSparseArray.put(LAYOUT_CONTENT_ID, mStatusLayoutManager.contentLayout);
            addView(mStatusLayoutManager.contentLayout);
