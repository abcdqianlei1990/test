...
public class RecognizeService {
    ...
    public static void recCustom(Context ctx, String filePath, final ServiceListener listener) {
        OcrRequestParams param = new OcrRequestParams();
//        param.putParam("templateSign", "6b5d939a23d0f97a5bbb8d2dc2e9318b");1080
//        param.putParam("templateSign","1f97c054e409011ac952ee880830dca2");720
        param.putParam("classifierId", 1);
        param.setImageFile(new File(filePath));
