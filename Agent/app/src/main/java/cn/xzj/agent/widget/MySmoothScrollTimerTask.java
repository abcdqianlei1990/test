...
public class MySmoothScrollTimerTask extends TimerTask {
    ...
    public MySmoothScrollTimerTask(MyWheelView wheelView, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 1) {
            ...
            wheelView.getHandler().sendEmptyMessage(MyWheelViewMessageHandler.WHAT_ITEM_SELECTED);
        } else {
            ...
            wheelView.getHandler().sendEmptyMessage(MyWheelViewMessageHandler.WHAT_INVALIDATE_LOOP_VIEW);
